...
filehandler = open('/Users/John/Documents/Carleton/Academia/Econ/Comps/Data/cabspottingdata/directions204741164463.obj','r')
...
def runParserOnObject(pickledObjectFile):		
	with open('/Users/John/Documents/Carleton/Academia/Econ/Comps/Data/cabspottingdata/' + pickledObjectFile,'r') as bartFareCSV:
		bartFareMatrix = [row for row in csv.reader(bartFareCSV.read().splitlines())]
	parseTransitData(bartFareMatrix)
